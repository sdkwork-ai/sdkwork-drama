...
Module `sdkwork-drama` · runtime code `drama` · enabled
...
| --- | --- | ---: | --- | --- |
| development | `server.development.toml` | 16 | `drama-dev.sdkwork.com` | 80 |
| test | `server.test.toml` | 16 | `drama-test.sdkwork.com` | 80 |
| staging | `server.staging.toml` | 16 | `drama-staging.sdkwork.com` | 80 |
| demo | `server.demo.toml` | 16 | `drama-demo.sdkwork.com` | 80 |
| production | `server.production.toml` | 16 | `drama.sdkwork.com` | 443 ssl + 80 |
