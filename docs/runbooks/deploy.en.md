# Runbook — sdkwork-drama deploy / upgrade / rollback (EN)
...
targets. Image reference: `registry.sdkwork.com/apps/sdkwork-drama-standalone:0.1.0`
...
install syncs the bundle to `/opt/deploy/sdkwork-drama/bundle`, loads the image, starts
